...
/**
 * GNIRS long slit behind Altair. The catalog query is the AOWFS candidates circle with the slowest
 * LGS limits in R (the widest Altair constraint), then the same candidates are analysed in NGS and
 * LGS mode.
 */
