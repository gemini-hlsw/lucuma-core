...
class ConditionsLikelihoodSuite extends munit.FunSuite:
  ...
  test("conditions likelihood"):
    assertEquals(conditionsLikelihood(SkyBackground.Bright, CloudExtinction.unsafeFromVegaMagnitude(3.0), WaterVapor.Wet, ImageQuality.unsafeFromArcSeconds(3.0), Wavelength.fromIntNanometers(1000).get, Declination.fromDoubleDegrees(20).get, Site.GN).toPercent.toDouble, 99.97)
    assertEquals(conditionsLikelihood(SkyBackground.Dark, CloudExtinction.unsafeFromVegaMagnitude(3.0), WaterVapor.Wet, ImageQuality.unsafeFromArcSeconds(3.0), Wavelength.fromIntNanometers(1000).get, Declination.fromDoubleDegrees(20).get, Site.GN).toPercent.toDouble, 49.98)
    assertEquals(conditionsLikelihood(SkyBackground.Dark, CloudExtinction.unsafeFromVegaMagnitude(0.1), WaterVapor.Wet, ImageQuality.unsafeFromArcSeconds(3.0), Wavelength.fromIntNanometers(1000).get, Declination.fromDoubleDegrees(20).get, Site.GN).toPercent.toDouble, 24.99)
    assertEquals(conditionsLikelihood(SkyBackground.Dark, CloudExtinction.unsafeFromVegaMagnitude(0.1), WaterVapor.Dry, ImageQuality.unsafeFromArcSeconds(3.0), Wavelength.fromIntNanometers(1000).get, Declination.fromDoubleDegrees(20).get, Site.GN).toPercent.toDouble, 12.49)
    assertEquals(conditionsLikelihood(SkyBackground.Dark, CloudExtinction.unsafeFromVegaMagnitude(0.1), WaterVapor.Wet, ImageQuality.unsafeFromArcSeconds(0.5), Wavelength.fromIntNanometers(500).get, Declination.fromDoubleDegrees(20).get, Site.GN).toPercent.toDouble, 4.20)
    assertEquals(conditionsLikelihood(SkyBackground.Dark, CloudExtinction.unsafeFromVegaMagnitude(0.1), WaterVapor.Wet, ImageQuality.unsafeFromArcSeconds(0.5), Wavelength.fromIntNanometers(500).get, Declination.fromDoubleDegrees(68).get, Site.GN).toPercent.toDouble, 1.22)
