...
case class Observation(p1Observation: Null /* edu.gemini.model.p1.immutable.Observation */, target: Target, conditions: ObservingConditions, time: Time, lgs: Boolean = false) extends CategorizedTime
