...
final case class RejectTarget(prop: Proposal, obs: ItacObservation, band: ScienceBand, raDecType: RejectTarget.RaDecType, cur: Time, max: Time) extends ObsRejectMessage {
