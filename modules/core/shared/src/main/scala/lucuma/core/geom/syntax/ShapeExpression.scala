...
trait shapeexpression {
  extension (self: ShapeExpression)
  ...
  extension(self: ShapeExpression.type)
    ...
    */
    ...
    /**
    * A single point `ShapeExpression`
    */
    def point(a: Offset): ShapeExpression =
      ShapeExpression.Point(a): ShapeExpression
