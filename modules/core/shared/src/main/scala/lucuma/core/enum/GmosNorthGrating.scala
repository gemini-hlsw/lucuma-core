...
object GmosNorthGrating {
  ...
  /** @group Constructors */ case object B1200_G5301 extends GmosNorthGrating("B1200_G5301", "B1200", "B1200_G5301", 1200, pmToDispersion( 26), false)
  /** @group Constructors */ case object R831_G5302  extends GmosNorthGrating("R831_G5302",  "R831",  "R831_G5302",   831, pmToDispersion( 38), false)
  /** @group Constructors */ case object B600_G5303  extends GmosNorthGrating("B600_G5303",  "B600",  "B600_G5303",   600, pmToDispersion( 45), true)
  /** @group Constructors */ case object B600_G5307  extends GmosNorthGrating("B600_G5307",  "B600",  "B600_G5307",   600, pmToDispersion( 50), false)
  /** @group Constructors */ case object R600_G5304  extends GmosNorthGrating("R600_G5304",  "R600",  "R600_G5304",   600, pmToDispersion( 52), false)
  /** @group Constructors */ case object B480_G5309  extends GmosNorthGrating("B480_G5309",  "B480",  "B480_G5309",   480, pmToDispersion( 62), false)
  /** @group Constructors */ case object R400_G5305  extends GmosNorthGrating("R400_G5305",  "R400",  "R400_G5305",   400, pmToDispersion( 74), false)
  /** @group Constructors */ case object R150_G5306  extends GmosNorthGrating("R150_G5306",  "R150",  "R150_G5306",   150, pmToDispersion(174), true)
  /** @group Constructors */ case object R150_G5308  extends GmosNorthGrating("R150_G5308",  "R150",  "R150_G5308",   150, pmToDispersion(193), false)
