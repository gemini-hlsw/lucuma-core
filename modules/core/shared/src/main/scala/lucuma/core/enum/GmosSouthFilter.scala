...
object GmosSouthFilter {
  ...
  /** @group Constructors */ case object UPrime extends GmosSouthFilter("UPrime", "u", "u_G0332", Wavelength.unsafeFromInt(350000), false, Interval(Wavelength.unsafeFromInt(336000), Wavelength.unsafeFromInt(385000)).some)
  /** @group Constructors */ case object GPrime extends GmosSouthFilter("GPrime", "g", "g_G0325", Wavelength.unsafeFromInt(475000), false, Interval(Wavelength.unsafeFromInt(398000), Wavelength.unsafeFromInt(552000)).some)
  /** @group Constructors */ case object RPrime extends GmosSouthFilter("RPrime", "r", "r_G0326", Wavelength.unsafeFromInt(630000), false, Interval(Wavelength.unsafeFromInt(562000), Wavelength.unsafeFromInt(698000)).some)
  /** @group Constructors */ case object IPrime extends GmosSouthFilter("IPrime", "i", "i_G0327", Wavelength.unsafeFromInt(780000), false, Interval(Wavelength.unsafeFromInt(706000), Wavelength.unsafeFromInt(850000)).some)
  /** @group Constructors */ case object ZPrime extends GmosSouthFilter("ZPrime", "z", "z_G0328", Wavelength.unsafeFromInt(925000), false, none)
  /** @group Constructors */ case object Z extends GmosSouthFilter("Z", "Z", "Z_G0343", Wavelength.unsafeFromInt(876000), false, Interval(Wavelength.unsafeFromInt(830000), Wavelength.unsafeFromInt(925000)).some)
  /** @group Constructors */ case object Y extends GmosSouthFilter("Y", "Y", "Y_G0344", Wavelength.unsafeFromInt(1010000), false, Interval(Wavelength.unsafeFromInt(970000), Wavelength.unsafeFromInt(1010000)).some)
  /** @group Constructors */ case object GG455 extends GmosSouthFilter("GG455", "GG455", "GG455_G0329", Wavelength.unsafeFromInt(680000), false, none, true)
  /** @group Constructors */ case object OG515 extends GmosSouthFilter("OG515", "OG515", "OG515_G0330", Wavelength.unsafeFromInt(710000), false, none, true)
  /** @group Constructors */ case object RG610 extends GmosSouthFilter("RG610", "RG610", "RG610_G0331", Wavelength.unsafeFromInt(750000), false, none, true)
  /** @group Constructors */ case object RG780 extends GmosSouthFilter("RG780", "RG780", "RG780_G0334", Wavelength.unsafeFromInt(850000), false, none, true)
  /** @group Constructors */ case object CaT extends GmosSouthFilter("CaT", "CaT", "CaT_G0333", Wavelength.unsafeFromInt(860000), false, Interval(Wavelength.unsafeFromInt(780000), Wavelength.unsafeFromInt(933000)).some)
  /** @group Constructors */ case object HartmannA_RPrime extends GmosSouthFilter("HartmannA_RPrime", "r+HartA", "HartmannA_G0337 + r_G0326", Wavelength.unsafeFromInt(630000), false, none, false, true)
  /** @group Constructors */ case object HartmannB_RPrime extends GmosSouthFilter("HartmannB_RPrime", "r+HartB", "HartmannB_G0338 + r_G0326", Wavelength.unsafeFromInt(630000), false, none, false, true)
  ...
  /** @group Constructors */ case object SII extends GmosSouthFilter("SII", "SII", "SII_G0335", Wavelength.unsafeFromInt(672000), false, Interval(Wavelength.unsafeFromInt(669400), Wavelength.unsafeFromInt(673700)).some)
  /** @group Constructors */ case object HaC extends GmosSouthFilter("HaC", "HaC", "HaC_G0337", Wavelength.unsafeFromInt(662000), false, Interval(Wavelength.unsafeFromInt(659000), Wavelength.unsafeFromInt(665000)).some)
  /** @group Constructors */ case object OIII extends GmosSouthFilter("OIII", "OIII", "OIII_G0338", Wavelength.unsafeFromInt(499000), false, Interval(Wavelength.unsafeFromInt(496500), Wavelength.unsafeFromInt(501500)).some)
