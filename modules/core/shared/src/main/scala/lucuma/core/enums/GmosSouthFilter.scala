...
object GmosSouthFilter {
  ...
  /** @group Constructors */ case object ZPrime           extends GmosSouthFilter("ZPrime",           "z",       "z_G0328",                    925_000.pm, false,  848_000.pmRange,             FilterType.BroadBand)
  ...
  /** @group Constructors */ case object GG455            extends GmosSouthFilter("GG455",            "GG455",   "GG455_G0329",                555_000.pm, false,  460_000.pmRange,             FilterType.Spectroscopic)
  /** @group Constructors */ case object OG515            extends GmosSouthFilter("OG515",            "OG515",   "OG515_G0330",                615_000.pm, false,  520_000.pmRange,             FilterType.Spectroscopic)
  /** @group Constructors */ case object RG610            extends GmosSouthFilter("RG610",            "RG610",   "RG610_G0331",                710_000.pm, false,  615_000.pmRange,             FilterType.Spectroscopic)
  /** @group Constructors */ case object RG780            extends GmosSouthFilter("RG780",            "RG780",   "RG780_G0334",                880_000.pm, false,  780_000.pmRange,             FilterType.Spectroscopic)
  ...
  /** @group Constructors */ case object HartmannA_RPrime extends GmosSouthFilter("HartmannA_RPrime", "r+HartA", "HartmannA_G0337 + r_G0326",  630_000.pm, false,  630_000.pmRange,             FilterType.Engineering)
  /** @group Constructors */ case object HartmannB_RPrime extends GmosSouthFilter("HartmannB_RPrime", "r+HartB", "HartmannB_G0338 + r_G0326",  630_000.pm, false,  630_000.pmRange,             FilterType.Engineering)
  ...
  /** @group Constructors */ case object Lya395           extends GmosSouthFilter("Lya395",           "Lya395",  "Lya395_G0342",               396_000.pm, true,   386_000.pmRange,             FilterType.NarrowBand)
