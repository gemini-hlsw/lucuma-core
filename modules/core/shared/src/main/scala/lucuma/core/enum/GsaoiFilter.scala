...
object GsaoiFilter {
  ...
  case object Z
      extends GsaoiFilter(
        ...
        "Z",
        "Z (1.015 um)",
        Wavelength.unsafeFromInt(1020000),
        GsaoiReadMode.Faint,
        26000.millis,
        4619000.millis,
  ...
  case object HeI
      extends GsaoiFilter(
        ...
        "HeI",
        "HeI (1.083 um)",
        Wavelength.unsafeFromInt(1080000),
  ...
  case object PaGamma
      extends GsaoiFilter(
        ...
        "Pagma",
        "Pa(gamma) (1.094 um)",
        Wavelength.unsafeFromInt(1090000),
        GsaoiReadMode.VeryFaint,
        122000.millis,
        36585000.millis,
        Some(WavelengthBand.J)
  ...
  case object JContinuum
      extends GsaoiFilter(
        ...
        Wavelength.unsafeFromInt(1210000),
        GsaoiReadMode.VeryFaint,
        32600.millis,
        9793000.millis,
        Some(WavelengthBand.J)
  ...
  case object H
      extends GsaoiFilter(
        ...
        "H",
        "H (1.635 um)",
        Wavelength.unsafeFromInt(1640000),
  ...
  case object PaBeta
      extends GsaoiFilter(
        ...
        "Pabeta",
        "Pa(beta) (1.282 um)",
        Wavelength.unsafeFromInt(1280000),
        GsaoiReadMode.Faint,
        21800.millis,
        3879000.millis,
        Some(WavelengthBand.J)
  ...
  case object HContinuum
      extends GsaoiFilter(
        ...
        Wavelength.unsafeFromInt(1570000),
        GsaoiReadMode.Faint,
        31200.millis,
        5545000.millis,
        Some(WavelengthBand.H)
  ...
  case object CH4Short
      extends GsaoiFilter(
        ...
        "CH4short",
        "CH4(short) (1.580 um)",
        Wavelength.unsafeFromInt(1580000),
        GsaoiReadMode.Faint,
        6600.millis,
        1174000.millis,
        Some(WavelengthBand.H)
  ...
  case object CH4Long
      extends GsaoiFilter(
        ...
        "CH4long",
        "CH4(long) (1.690 um)",
        Wavelength.unsafeFromInt(1690000),
        GsaoiReadMode.Faint,
        6800.millis,
        1202000.millis,
        Some(WavelengthBand.H)
  ...
  case object H20Ice
      extends GsaoiFilter(
        ...
        "H20ice",
        "H20 ice (2.000 um)",
        Wavelength.unsafeFromInt(2000000),
        GsaoiReadMode.Faint,
        19100.millis,
        3395000.millis,
  ...
  case object HeI2p2s
      extends GsaoiFilter(
        ...
        "HeI2p2s",
        "HeI (2p2s) (2.058 um)",
        Wavelength.unsafeFromInt(2060000),
        GsaoiReadMode.Faint,
        28300.millis,
        5032000.millis,
        Some(WavelengthBand.K)
  ...
  case object KContinuum1
      extends GsaoiFilter(
        ...
        Wavelength.unsafeFromInt(2090000),
        GsaoiReadMode.Faint,
        7800.millis,
        6069000.millis,
        Some(WavelengthBand.K)
  ...
  case object BrGamma
      extends GsaoiFilter(
        ...
        "Brgma",
        "Br(gamma) (2.166 um)",
        Wavelength.unsafeFromInt(2170000),
        GsaoiReadMode.Faint,
        31000.millis,
        5496000.millis,
        Some(WavelengthBand.K)
  ...
  case object KContinuum2
      extends GsaoiFilter(
        ...
        Wavelength.unsafeFromInt(2270000),
        GsaoiReadMode.Faint,
        33300.millis,
        5911000.millis,
        Some(WavelengthBand.K)
  ...
  case object KPrime
      extends GsaoiFilter(
        ...
        "Kprime",
        "K(prime) (2.120 um)",
        Wavelength.unsafeFromInt(2120000),
        GsaoiReadMode.Bright,
        14800.millis,
        566000.millis,
        Some(WavelengthBand.K)
  ...
  case object KShort
      extends GsaoiFilter(
        ...
        "Kshort",
        "K(short) (2.150 um)",
        Wavelength.unsafeFromInt(2150000),
        GsaoiReadMode.Bright,
        14400.millis,
        551000.millis,
        Some(WavelengthBand.K)
  ...
  case object K
      extends GsaoiFilter(
        ...
        "K",
        "K (2.200 um)",
        Wavelength.unsafeFromInt(2200000),
        GsaoiReadMode.Bright,
        12300.millis,
        470000.millis,
        Some(WavelengthBand.K)
  ...
  case object H2_2_1_S_1
      extends GsaoiFilter(
        ...
        "H2(2-1)",
        "H2 2-1 S(1) (2.248 um)",
        Wavelength.unsafeFromInt(2250000),
        GsaoiReadMode.Faint,
        32600.millis,
        5784000.millis,
        Some(WavelengthBand.K)
  ...
  case object CO
      extends GsaoiFilter(
        ...
        "CO2360",
        "CO (2.360 um)",
        Wavelength.unsafeFromInt(2360000),
        GsaoiReadMode.Faint,
        7700.millis,
        1370000.millis,
        Some(WavelengthBand.K)
