...
//
def conditionsLikelihood(bg: SkyBackground, ce: CloudExtinction, wv: WaterVapor, fwhm: ImageQuality, wavelength: Wavelength, dec: Declination, site: Site): Percentile =
    (bg.percentile *
      ce.percentile  *
