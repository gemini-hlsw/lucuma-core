...
object EphemerisKey extends EphemerisOptics {
  ...
  object AsteroidOld {
    val num: monocle.Lens[AsteroidOld, Int] = Focus[AsteroidOld](_.num)
  }
  ...
  object MajorBody {
    val num: monocle.Lens[MajorBody, Int] = Focus[MajorBody](_.num)
  }
  ...
  object UserSupplied {
    val id: monocle.Lens[UserSupplied, Int] = Focus[UserSupplied](_.id)
  }
