...
object GmosNorthFpu {
  ...
  /** @group Constructors */ case object Ns0 extends GmosNorthFpu("Ns0", "NS0.25\"", "N and S 0.25 arcsec", Some(Angle.fromDoubleArcseconds(0.25)), Angle.fromDoubleArcseconds(0.000))
  /** @group Constructors */ case object Ns1 extends GmosNorthFpu("Ns1", "NS0.5\"", "N and S 0.50 arcsec", Some(Angle.fromDoubleArcseconds(0.50)), Angle.fromDoubleArcseconds(0.000))
  /** @group Constructors */ case object Ns2 extends GmosNorthFpu("Ns2", "NS0.75\"", "N and S 0.75 arcsec", Some(Angle.fromDoubleArcseconds(0.75)), Angle.fromDoubleArcseconds(0.000))
  /** @group Constructors */ case object Ns3 extends GmosNorthFpu("Ns3", "NS1.0\"", "N and S 1.00 arcsec", Some(Angle.fromDoubleArcseconds(1.00)), Angle.fromDoubleArcseconds(0.000))
