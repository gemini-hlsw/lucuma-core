...
object GmosNorthFilter {
  ...
  /** @group Constructors */ case object Ri extends GmosNorthFilter("Ri", "r+i", "ri_G0349", Wavelength.unsafeFromIntPicometers(705000), false, Interval(Wavelength.unsafeFromIntPicometers(560000), Wavelength.unsafeFromIntPicometers(850000)).some, FilterType.BroadBand)
  ...
  /** @group Constructors */ case object OVI extends GmosNorthFilter("OVI", "OVI", "OVI_G0345", Wavelength.unsafeFromIntPicometers(684000), false, Interval(Wavelength.unsafeFromIntPicometers(681600), Wavelength.unsafeFromIntPicometers(686500)).some, FilterType.NarrowBand)
  /** @group Constructors */ case object OVIC extends GmosNorthFilter("OVIC", "OVIC", "OVIC_G0346", Wavelength.unsafeFromIntPicometers(679000), false, Interval(Wavelength.unsafeFromIntPicometers(676100), Wavelength.unsafeFromIntPicometers(680900)).some, FilterType.NarrowBand)
