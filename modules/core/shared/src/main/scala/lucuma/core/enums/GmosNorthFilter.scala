...
object GmosNorthFilter {
  ...
  /** @group Constructors */ case object ZPrime           extends GmosNorthFilter("ZPrime",           "z",       "z_G0304",                   925_000.pm, false,  848_000.pmRange,             FilterType.BroadBand)
  ...
  /** @group Constructors */ case object GG455            extends GmosNorthFilter("GG455",            "GG455",   "GG455_G0305",               555_000.pm, false,  460_000.pmRange,             FilterType.Spectroscopic)
  /** @group Constructors */ case object OG515            extends GmosNorthFilter("OG515",            "OG515",   "OG515_G0306",               615_000.pm, false,  520_000.pmRange,             FilterType.Spectroscopic)
  /** @group Constructors */ case object RG610            extends GmosNorthFilter("RG610",            "RG610",   "RG610_G0307",               710_000.pm, false,  615_000.pmRange,             FilterType.Spectroscopic)
  ...
  /** @group Constructors */ case object HartmannA_RPrime extends GmosNorthFilter("HartmannA_RPrime", "r+HartA", "HartmannA_G0313 + r_G0303", 630_000.pm, false,  630_000.pmRange,             FilterType.Engineering)
  /** @group Constructors */ case object HartmannB_RPrime extends GmosNorthFilter("HartmannB_RPrime", "r+HartB", "HartmannB_G0314 + r_G0303", 630_000.pm, false,  630_000.pmRange,             FilterType.Engineering)
