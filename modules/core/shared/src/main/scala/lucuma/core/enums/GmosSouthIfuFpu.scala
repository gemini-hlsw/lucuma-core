...
enum GmosSouthIfuFpu(
  ...
  case TwoSlits extends GmosSouthIfuFpu("TwoSlits", "IFU-2", "IFU 2 Slits",          GmosSouthFpu.Ifu2Slits)
  case OneSlit  extends GmosSouthIfuFpu("OneSlit",  "IFU-R", "IFU Right Slit (red)", GmosSouthFpu.IfuRed)
