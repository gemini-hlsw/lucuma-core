...
object GmosXBinning extends NewType[GmosBinning]:
  ...
  val Two  = GmosXBinning(GmosBinning.Two)
  val Four = GmosXBinning(GmosBinning.Four)

  given Enumerated[GmosXBinning] = Enumerated.from(One, Two, Four).withTag(_.tag)
...
object GmosYBinning extends NewType[GmosBinning]:
  ...
  val Two  = GmosYBinning(GmosBinning.Two)
  val Four = GmosYBinning(GmosBinning.Four)

  given Enumerated[GmosYBinning] = Enumerated.from(One, Two, Four).withTag(_.tag)
