...
enum FacilityObservingModeType(
  ...
  case GmosNorthIfu       extends FacilityObservingModeType("gmos_north_ifu",        Instrument.GmosNorth,  PosAngleConstraint.Fixed(Angle.Angle0))
  ...
  case GmosSouthIfu       extends FacilityObservingModeType("gmos_south_ifu",        Instrument.GmosSouth,  PosAngleConstraint.Fixed(Angle.Angle0))
